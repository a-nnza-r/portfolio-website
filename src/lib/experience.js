const experienceData = [
  ...
  },
  {
    ...
    company: "SCDF (Singapore Civil Defence Force)",
    description: "National Service",
    details: [
      "As the Co-lead of the Community Engagement Branch at the 4th Division HQ of SCDF, I handled various ad-hoc and leadership duties in addition to my role as a Community Engagement Specialist.",
      "As a Community Engagement Specialist, I trained Community Emergency Preparedness Program (CEPP) participants in various First-aid and small firefighting techniques. This included conducting CPR training, which involved teaching participants through demonstrations and supervising practices on CPR mannequins.",
      "I worked with and trained a wide range of participants, including school children and the elderly, requiring a high level of approachability and engagement skills.",
    ],
  },
];
