...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 md:py-16 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.70]">
      <motion.h2
        style={{
        ...
        {title}
          <TextGenerateEffect words={personalWriteUp} customClassNames={"text-sm font-light text-center max-w-[90%] md:max-w-[70%] mx-auto py-8 whitespace-pre-line"}/>
      </motion.h2>
      {/* Lid */}
      <Lid
        src={src}
      ...
      {/* Base area */}
      <div
        className="sm:h-[22rem] sm:w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
